    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="block-disclaimer">
                <h5>Disclaimer</h5>
                <p
                    >All of the above information is for reference only. Although reasonable and
                    cautious measures are applied to prepare the above information,
                    Livethere/Savills does not warrant the accuracy, timeliness, reasonableness or
                    completeness of any such information and valuation or whether they are fit for
                    any purposes. Livethere/Savills does not assume any liabilities of any kind to
                    you for any reliance on such information and valuation or owe any duty of care
                    to you as a result of providing such information.</p
                >
            </div>
        </div>
    </div>
        ...
        portfolio() {
            return this.dashboard
                ? {
                      ...
                      estimatedPortfolioPriceCurrentYear: this.dashboard
                      ...
                      portfolioPriceYieldRate: this.dashboard.portfolioPriceYieldRate
                          ? this.dashboard.portfolioPriceYieldRate.toFixed(2)
                          : 0,
                      purchasePriceOfPortfolio: this.dashboard.purchasePriceOfPortfolio
                          ? this.dashboard.purchasePriceOfPortfolio
                          : 0,
                      purchasePriceOfPortfolioRate: this.dashboard.purchasePriceOfPortfolioRate
                          ? this.dashboard.purchasePriceOfPortfolioRate.toFixed(2)
                          : 0,
        ...
        incomeLastYear() {
            return this.dashboard
                ? {
                      ...
                      data: this.dashboard.lastYearIncomeData
                          ? this.dashboard.lastYearIncomeData.map((val) => val.value)
                          : [],
                      ...
                      incomeRate: this.dashboard.incomeLastYearRate
                          ? this.dashboard.incomeLastYearRate.toFixed(2)
                          : 0,
        ...
        incomeCurrentYear() {
            return this.dashboard
                ? {
                      ...
                      labels: this.dashboard.currentYearIncomeData
                          ? this.dashboard.currentYearIncomeData.map((val) => val.name)
                          : [],
                      data: this.dashboard.currentYearIncomeData
                          ? this.dashboard.currentYearIncomeData.map((val) => val.value)
                          : [],
                      ...
                      price: this.dashboard.incomeCurrentYear
                          ? this.dashboard.incomeCurrentYear
                          : 0,
                      incomeRate: this.dashboard.incomeCurrentYearRate
                          ? this.dashboard.incomeCurrentYearRate.toFixed(2)
                          : 0,
                      lineColor: this.dashboard.currentYearIncomeData
                          ? this.dashboard.currentYearIncomeData.map((val) =>
                                val.forecastValue
