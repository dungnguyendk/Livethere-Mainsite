<template>
    <table class=" table--responsive table--marketing-inventory">
        <thead>
        <tr>
        ...
        <template v-if="items.length >0">
            <tr v-for="item in items" :key="item.id">
                ...
                <td headers="relationship" data-title="Relationship Manager">
                    <p>
                        {{ item.relationshipName }} <br/>{{
                            item.relationshipPhoneNumber
                        }}
                    </p>
                </td>
...
<script>
// import MarketingInventoryRecord from './Table/MarketingInventoryRecord.vue';
export default {
    name: "MarketingInventoryTable",
    //   components: {
    //       MarketingInventoryRecord
    //     }
    data() {
        return {
            items: [
